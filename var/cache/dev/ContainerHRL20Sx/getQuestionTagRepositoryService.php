 ...
 */
class getQuestionTagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuestionTagRepository' shared autowired service.
     *
     * @return \App\Repository\QuestionTagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuestionTagRepository.php';

        return $container->privates['App\\Repository\\QuestionTagRepository'] = new \App\Repository\QuestionTagRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
