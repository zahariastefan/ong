...
class getAdminControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.3oR_vrd'] ?? $container->load('get_ServiceLocator_3oRVrdService'))->withContext('App\\Controller\\AdminController', $container));
