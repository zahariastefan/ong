 ...
 */
class getTotalVotesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TotalVotesRepository' shared autowired service.
     *
     * @return \App\Repository\TotalVotesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TotalVotesRepository.php';

        return $container->privates['App\\Repository\\TotalVotesRepository'] = new \App\Repository\TotalVotesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
