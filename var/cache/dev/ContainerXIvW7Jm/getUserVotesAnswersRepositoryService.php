 ...
 */
class getUserVotesAnswersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserVotesAnswersRepository' shared autowired service.
     *
     * @return \App\Repository\UserVotesAnswersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserVotesAnswersRepository.php';

        return $container->privates['App\\Repository\\UserVotesAnswersRepository'] = new \App\Repository\UserVotesAnswersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
