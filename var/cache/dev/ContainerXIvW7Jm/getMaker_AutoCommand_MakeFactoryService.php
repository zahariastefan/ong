...
class getMaker_AutoCommand_MakeFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['maker.auto_command.make_factory'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Zenstruck\Foundry\Bundle\Maker\MakeFactory(($container->privates['Zenstruck\\Foundry\\ChainManagerRegistry'] ?? $container->load('getChainManagerRegistryService')), new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['App\\Factory\\CitiesFactory'] ?? ($container->privates['App\\Factory\\CitiesFactory'] = new \App\Factory\CitiesFactory()));
            yield 3 => ($container->privates['App\\Factory\\ProductsFactory'] ?? ($container->privates['App\\Factory\\ProductsFactory'] = new \App\Factory\ProductsFactory()));
            yield 4 => ($container->privates['App\\Factory\\QuestionFactory'] ?? ($container->privates['App\\Factory\\QuestionFactory'] = new \App\Factory\QuestionFactory()));
            yield 5 => ($container->privates['App\\Factory\\QuestionTagFactory'] ?? ($container->privates['App\\Factory\\QuestionTagFactory'] = new \App\Factory\QuestionTagFactory()));
            yield 6 => ($container->privates['App\\Factory\\TagFactory'] ?? ($container->privates['App\\Factory\\TagFactory'] = new \App\Factory\TagFactory()));
            yield 7 => ($container->privates['App\\Factory\\UniqueCodesFactory'] ?? ($container->privates['App\\Factory\\UniqueCodesFactory'] = new \App\Factory\UniqueCodesFactory()));
            yield 8 => ($container->privates['App\\Factory\\UserFactory'] ?? $container->load('getUserFactoryService'));
        }, 9)), ($container->privates['maker.file_manager'] ?? $container->load('getMaker_FileManagerService')), ($container->privates['maker.generator'] ?? $container->load('getMaker_GeneratorService')));
