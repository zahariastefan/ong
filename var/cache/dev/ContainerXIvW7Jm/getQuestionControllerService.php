...
class getQuestionControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.YGRC_XS'] ?? $container->load('get_ServiceLocator_YGRCXSService'))->withContext('App\\Controller\\QuestionController', $container));
