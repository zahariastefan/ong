...
class getCommentControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.r.v7p0F'] ?? $container->load('get_ServiceLocator_R_V7p0FService'))->withContext('App\\Controller\\CommentController', $container));
