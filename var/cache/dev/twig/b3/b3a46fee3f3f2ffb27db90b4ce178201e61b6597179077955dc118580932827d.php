    ...
    ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_REMEMBERED")) {
            ...
            echo "                <div
                        ...
                        ";
            // line 26
            echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusController($this->env, "answer-vote", ["url" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("answer_vote", ["id" => twig_get_attribute($this->env, $this->source,             // line 28
(isset($context["answer"]) || array_key_exists("answer", $context) ? $context["answer"] : (function () { throw new RuntimeError('Variable "answer" does not exist.', 28, $this->source); })()), "id", [], "any", false, false, false, 28)])]);
            // line 30
            echo "
                >
                    <button
                            ...
                            ";
            // line 36
            echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusAction($this->env, "answer-vote", "clickVote");
            echo "
            ...
            echo "
                    ...
                    <span><span ";
            // line 44
            echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\StimulusTwigExtension']->renderStimulusTarget($this->env, "answer-vote", "voteTotal");
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["answer"]) || array_key_exists("answer", $context) ? $context["answer"] : (function () { throw new RuntimeError('Variable "answer" does not exist.', 44, $this->source); })()), "votes", [], "any", false, false, false, 44), "html", null, true);
            echo "</span></span>
                </div>
            ";
        }
...
";
    ...
    {
        return array (  129 => 47,  121 => 44,  116 => 42,  107 => 36,  99 => 30,  97 => 28,  96 => 26,  92 => 24,  90 => 23,  86 => 22,  80 => 19,  76 => 18,  70 => 15,  66 => 13,  60 => 10,  54 => 6,  52 => 5,  51 => 4,  48 => 3,  46 => 2,  43 => 1,);
    }
