...
class __TwigTemplate_4d079d3fc12b6ea19fe54e8bfaf19cc63ddd6921915ed83e137da5c244975337 extends Template
{
    ...
    <div class=\"container\">
        <form action=\"";
        // line 6
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_load_post", ["submitted" => 1]);
        echo "\" method=\"POST\" class=\"d-grid\">
            <label for=\"post_title\">Title</label>
            <input type=\"text\" placeholder=\"Type your title of Post...\" name=\"post_title\">

            <label for=\"slug_post\">Choose a Slug</label>
            <input type=\"text\" name=\"slug_post\" placeholder=\"Type your Slug...\">

            <label for=\"content_field\">Content</label>
            <textarea name=\"content_field\" id=\"content_field\" cols=\"100\" rows=\"10\" placeholder=\"Type your Content Here...\"></textarea>
...
{% block body %}
    ...
    <div class=\"container\">
        <form action=\"{{ path('app_load_post', { submitted: 1 }) }}\" method=\"POST\" class=\"d-grid\">
            <label for=\"post_title\">Title</label>
            <input type=\"text\" placeholder=\"Type your title of Post...\" name=\"post_title\">
...
", "create_post.html.twig", "C:\\ONG symfony 5 new\\ong5\\templates\\create_post.html.twig");
    }
}
