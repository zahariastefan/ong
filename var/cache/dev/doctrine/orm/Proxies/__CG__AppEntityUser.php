...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'App\\Entity\\User' . "\0" . 'questions', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isVerified', '' . "\0" . 'App\\Entity\\User' . "\0" . 'totpSecret'];
        }
    ...
    public function getAvatarUri(int $size = 32): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvatarUri', [$size]);

        return parent::getAvatarUri($size);
    }
     ...
     * {@inheritDoc}
     */
    public function setTotpSecret(?string $totpSecret): \App\Entity\User
    {
