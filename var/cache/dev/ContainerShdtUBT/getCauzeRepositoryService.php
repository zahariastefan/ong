 ...
 */
class getCauzeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CauzeRepository' shared autowired service.
     *
     * @return \App\Repository\CauzeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CauzeRepository.php';

        return $container->privates['App\\Repository\\CauzeRepository'] = new \App\Repository\CauzeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
